...
var upCmd = &ffcli.Command{
	...
	ShortHelp:  "Connect to MESH, logging in if needed",

	LongHelp: strings.TrimSpace(`
"meshcli up" connects this machine to your MESH network,
triggering authentication if necessary.

With no flags, "meshcli up" brings the network online without
changing any settings. (That is, it's the opposite of "meshcli
down").
